...
sudo docker run -v /home/dineshkumar/Codes/digit-classification/models:/digits/models  docker_assigment:v1 --total_run 1 --dev_size 0.2 --test_size 0.2 --model_type 'svm' 
#same docker run command to train tree model
sudo docker run -v /home/dineshkumar/Codes/digit-classification/models:/digits/models  docker_assigment:v1 --total_run 1 --dev_size 0.2 --test_size 0.2 --model_type 'tree'
